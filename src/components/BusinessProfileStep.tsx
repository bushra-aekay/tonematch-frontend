...
const BusinessProfileStep: FC<BusinessProfileStepProps> = ({ onNext, inititalData}) => {
    ...
    return (
        <div className="bg-gray-900/50 backdrop-blur-sm p-6 rounded-3xl border border-gray-800/50 w-full max-w-6xl mx-auto">
            <div className="mb-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-4">
                        {/* Project Name */}
                        <div>
                            <label htmlFor="name" className="block text-xs font-medium text-white/90 mb-1.5">
                            ...
                            <input
                                ...
                                required
                                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-xl text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all"
                        ...
                        {/* Short Description */}
                        <div>
                            <label htmlFor="shortDescription" className="block text-xs font-medium text-white/90 mb-1.5">
                            ...
                            <textarea
                                ...
                                required
                                rows={2}
                                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-xl text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all resize-none"
                        ...
                        {/* Target Audience */}
                        <div>
                            <label htmlFor="targetAudience" className="block text-xs font-medium text-white/90 mb-1.5">
                        ...
                        {/* Industry */}
                        <div>
                            <label htmlFor="industry" className="block text-xs font-medium text-white/90 mb-1.5">
                                Industry
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Mission */}
                        <div>
                            <label htmlFor="mission" className="block text-xs font-medium text-white/90 mb-1.5">
                                Mission
                            </label>
                            <textarea
                                name="mission"
                                ...
                                rows={2}
                                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-xl text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all resize-none"
                                placeholder="Your core value proposition"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        {/* Website Link */}
                        <div>
                            <label htmlFor="websiteLink" className="block text-xs font-medium text-white/90 mb-1.5">
                                Website
                            </label>
                            <input
                                type="url"
                        ...
                        {/* Current Marketing */}
                        <div>
                            <label htmlFor="currentMarketing" className="block text-xs font-medium text-white/90 mb-1.5">
                                Current Marketing
                            </label>
                            <textarea
                                ...
                                rows={2}
                                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-xl text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all resize-none"
                                placeholder="Your current strategy"
                            />
                        </div>

                        {/* Platforms Currently Used */}
                        <div>
                            <label htmlFor="platformsCurrentlyUsed" className="block text-xs font-medium text-white/90 mb-1.5">
                                Current Platforms
                            </label>
                            <input
                                type="text"
                        ...
                        {/* Brand Keywords */}
                        <div>
                            <label htmlFor="brandKeywords" className="block text-xs font-medium text-white/90 mb-1.5">
                                Core Keywords
                            </label>
                            <input
                                type="text"
                                ...
                                onChange={handleChange}
                                className="w-full px-3 py-2 bg-gray-800/50 border border-gray-700/50 rounded-xl text-sm text-white placeholder-gray-500 focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500/50 transition-all"
                                placeholder="consistency, automation, AI"
                            />
                            <p className="text-xs text-white/30 mt-1">
                                Comma-separated
                            </p>
                        ...
                        {/* Voice Description */}
                        <div>
                            <label htmlFor="voice" className="block text-xs font-medium text-white/90 mb-1.5">
                                Brand Voice
                            </label>
                            <input
                                type="text"
                            ...
                            />
                            <p className="text-xs text-white/30 mt-1">
                                Optional - we'll generate if blank
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-4 border-t border-gray-800/50">
                    <button
                        ...
                        className={`flex items-center px-8 py-2.5 rounded-xl text-white font-semibold transition-all
                            ${isFormValid
